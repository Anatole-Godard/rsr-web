...
//                   <span className="flex items-center justify-center flex-shrink-0 w-[2.25rem] h-[2.25rem] bg-green-200 rounded-lg dark:bg-green-900">
//                     <InformationCircleIcon className="w-4 h-4 text-green-700 dark:text-green-400" />
//                   </span>
//                   <input
//                     type="text"
//                     id="name"
